var city = "seoul";
    $.getJSON // 현재 날씨 (Current Weather Data)
    ('http://api.openweathermap.org/data/2.5/forecast?q='+city+'&appid=866315eec302cac5409c1d8c6f88c94b&units=metric', function(data){
        //data로 할일...
        ...
        $('.icon').append('<img src="http://openweathermap.org/img/wn/'+$weather_icon+'@2x.png">');
        $('.time').append($year+"년 "+$month+"월 "+$day+"일");

        $('.alertweather_tmp').append("℃");
        $('.alertweather_tmp_feels_like').append("℃");
    });
    $.getJSON // 시간대별 날씨 (Hourly Forecast)
    ('https://api.openweathermap.org/data/2.5/onecall?lat=37.5833&lon=127&appid=866315eec302cac5409c1d8c6f88c94b&units=metric', function(hourly_data){
        function convertTime(t){
          var $ot = new Date(t*1000);
          var $dn = "오전";
          var $hr = $ot.getHours();
        ...
        $('.icon0').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon1').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon2').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon3').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon4').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon5').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon6').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
        ...
        $('.icon7').append('<img src="http://openweathermap.org/img/wn/'+$icon+'@2x.png">');
