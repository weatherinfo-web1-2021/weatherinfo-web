var city = "seoul";
    ...
    ('https://api.openweathermap.org/data/2.5/onecall?lat=37.5833&lon=127&appid=866315eec302cac5409c1d8c6f88c94b&units=metric', function(hourly_data){
        ...
        $('.icon0').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon1').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon2').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon3').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon4').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon5').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon6').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
        ...
        $('.icon7').append('<img src="http://openweathermap.org/img/wn/'+$icon+'.png">');
